...
class FCDenseNet(nn.Module):
    def __init__(self, in_channels=3, down_blocks=(5,5,5,5,5),
                 ...
                 growth_rate=16, out_chans_first_conv=48, out_channels=12):
        super().__init__()
...
def FCDenseNet57(in_channels, out_channels):
    return FCDenseNet(
...
def FCDenseNet67(in_channels, out_channels):
    return FCDenseNet(
...
def FCDenseNet103(in_channels, out_channels):
    return FCDenseNet(
