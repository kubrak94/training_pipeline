...
class MyPlainUnet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, start_features_num=16, expand_rate=2, kernel_sizes=[5,2,5,2,5], 
        ...
        self.final_conv = ConvBlock(start_features_num,out_channels, kernel_sizes[0],
                                     strides[0], paddings[0], bias, activation = final_activation)
...
def myPlainUnet(in_channels, out_channels, final_activation):
    return MyPlainUnet(in_channels,out_channels, 16, 2, final_activation=final_activation)
